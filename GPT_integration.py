...
def initial_screen():
    ...
    user_input = st.text_input(key="user_input", placeholder="Ask your question here", label="enter_your_question", on_change=start_conversation)
