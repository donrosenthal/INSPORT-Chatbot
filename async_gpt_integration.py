...
def initial_screen():
    ...
    # Input area with hidden label
    user_input = st.text_input("Your question", key="user_input", placeholder="Ask your question here", label_visibility="collapsed", on_change=start_conversation)
